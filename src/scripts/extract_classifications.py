...
def extract_dzialy():
    ...
    pdf_path = Path(__file__).parent.parent.parent / "docs" / "Wyciąg nr 2a z Rozporządzenia - klasyfikacja działów.pdf"
...
def extract_rozdzialy():
    ...
    pdf_path = Path(__file__).parent.parent.parent / "docs" / "Wyciąg nr 2b z Rozporządzenia - klasyfikacja rozdziałów.pdf"
